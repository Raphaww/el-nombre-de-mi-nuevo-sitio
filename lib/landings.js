      ...
      components: {
         items: [
            ...
            },
            {
               id: 10,
               type: enums.componentType.MEDIA,
               title: 'Curabitur ullamcorper turpis tortor',
               content: `
                  <p>Vivamus sed viverra turpis. Sed nibh lectus, suscipit vel velit ut, pulvinar faucibus ex. Aenean vel mi nec eros facilisis auctor quis id ligula.</p>
               `,
               linkUrl: '#',
               linkText: 'Suspendisse iaculis',
               notContained: true,
               images: {
                  items: [
                  ...
                  items: [
                     {
                        id: 15,
                        size: 4,
                        type: enums.componentType.CALL_TO_ACTION,
                        title: 'Pellentesque lacinia',
                        content: 'Nam pharetra leo id est lacinia euismod sapien sed arcu.<br />Sed gravida id at nibh.',
                        linkUrl: '#',
                        linkText: 'Quisque commodo',
                        images:{
                           items: [
                              { path: 'hotelflamingos/1/58207b33-9-UNADJUSTEDNONRAW_thumb_2c98.jpg' }
                           ]
                        }
                     },
                     {
